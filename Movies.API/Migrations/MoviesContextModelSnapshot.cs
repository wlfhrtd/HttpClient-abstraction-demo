            ...
            modelBuilder.Entity("Movies.API.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Genre = "Crime, Drama",
                            ReleaseDate = new DateTimeOffset(new DateTime(1994, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            Title = "Pulp Fiction"
                        },
                        new
                        {
                            ...
                            DirectorId = new Guid("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                            Genre = "Crime, Drama",
                            ReleaseDate = new DateTimeOffset(new DateTime(1997, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            Title = "Jackie Brown"
                        },
                        new
                        {
                            ...
                            Genre = "Comedy, Crime",
                            ReleaseDate = new DateTimeOffset(new DateTime(1998, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Genre = "Crime, Drama",
                            ReleaseDate = new DateTimeOffset(new DateTime(1995, 11, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            Title = "Casino"
                        },
                        new
                        {
                            ...
                            Genre = "Drama",
                            ReleaseDate = new DateTimeOffset(new DateTime(1999, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 4, 0, 0, 0)),
                            Title = "Fight Club"
                        },
                        new
                        {
                            ...
                            ReleaseDate = new DateTimeOffset(new DateTime(1995, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 4, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Genre = "Action, Sci-Fi",
                            ReleaseDate = new DateTimeOffset(new DateTime(1991, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 4, 0, 0, 0)),
